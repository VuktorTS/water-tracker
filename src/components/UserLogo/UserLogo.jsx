  ...
  return (
    <Div>
      ...
      >
        ...
        {logoutModal && <ModalWrapper onClose={onCloseLogoutModal} title="Log out" alignItems="center"><LogOutModal question="Do you really want to leave?" butText="Log out" onClose={onCloseLogoutModal} onLogout={onLogout}/></ModalWrapper>}
      </UserLogoModal>
    </Div>
  )
}